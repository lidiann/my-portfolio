...
export default function Home() {
  return (
    <div>
      {/* 1. Hero Section */}
      <section className="flex flex-col items-center justify-center text-center bg-gray-50 py-24 md:py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full">TypeScript</span>
              <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full">FastAPI</span>
            </div>
          ...
          <div className="border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            {/* Tech stack badges */}
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="bg-purple-100 text-purple-800 text-xs font-medium px-2.5 py-0.5 rounded-full">OCaml</span>
              <span className="bg-purple-100 text-purple-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Bonsai</span>
              <span className="bg-purple-100 text-purple-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Async</span>
            </div>
            <Link href="/projects" className="font-medium text-black hover:underline inline-flex items-center">
              See details <FaArrowRight className="ml-1" />
            </Link>
      ...
      <section className="max-w-7xl mx-auto py-24 px-8 text-center">
        ...
        <div className="flex justify-center gap-6">
          <a href="mailto:Ispearsguerra@gmail.com" className="text-lg font-medium hover:underline">
            Email
          </a>
          <a href="https://linkedin.com/in/lidiannspearsguerra/" target="_blank" rel="noopener noreferrer" className="text-lg font-medium hover:underline">
            LinkedIn
          </a>
          <a href="https://github.com/lidiann" target="_blank" rel="noopener noreferrer" className="text-lg font-medium hover:underline">
            GitHub
          </a>
        </div>
      </section>
